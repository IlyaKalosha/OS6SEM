...
public:
	...
	virtual HRESULT __stdcall HTCreate(int Capacity, int SecSnapshotInterval, int MaxKeyLength, int MaxPayloadLength, const char FileName[512], HT::HTHANDLE*& HTHANDLE);
