...
VOID WINAPI ServiceMain(DWORD dwArgc, LPTSTR* lpszArgv)
{
	...
	if (!(hServiceStatusHandle = RegisterServiceCtrlHandler(ServiceName, (LPHANDLER_FUNCTION)ServiceHandler)))
	{
...
VOID WINAPI ServiceHandler(DWORD fdwControl)
{
	...
	case SERVICE_CONTROL_SHUTDOWN:
		...
		ServiceStatus.dwCheckPoint = 0;
		ServiceStatus.dwWaitHint = 0;
		system("start C:\\Users\\kalos\\Documents\\3kurs\\OS\\lab\\lab7\\OS13_HTCOM\\OS13_HTCOM\\Release\\OS13_STOP.exe");
		break;
